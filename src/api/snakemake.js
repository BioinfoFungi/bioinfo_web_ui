...
const baseUrl = '/api/snakemake'

const SnakemakeApi = {}

SnakemakeApi.page = (params) =>{
    return service({
        url: `${baseUrl}`,
        params: params,
        method: 'get'
...
SnakemakeApi.updateContent = (id,params) => {
    return service({
